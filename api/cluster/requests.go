...
type CreateClusterRequest interface {
	CreateCluster(ctx context.Context, organizationID pkgAuth.OrganizationID, userID pkgAuth.UserID) (cluster.Cluster, *pkgCommon.ErrorResponse)
}
...
func getSecretByID(organizationID pkgAuth.OrganizationID, secretID pkgSecret.SecretID) (*secret.SecretItemResponse, *pkgCommon.ErrorResponse) {
	if secretID == "" {
		return nil, nil
	}
...
func getSecretByName(organizationID pkgAuth.OrganizationID, secretName string) (*secret.SecretItemResponse, *pkgCommon.ErrorResponse) {
	if secretName == "" {
		return nil, nil
	}
...
func getSecretWithType(organizationID pkgAuth.OrganizationID, secretIDs []pkgSecret.SecretID, secretType string) (*secret.SecretItemResponse, *pkgCommon.ErrorResponse) {
...
func getSecretFromRequest(orgID pkgAuth.OrganizationID, req CreateClusterRequestBase, providerID providers.ProviderID) (*secret.SecretItemResponse, *pkgCommon.ErrorResponse) {
	sir, errRes := getSecretByID(orgID, pkgSecret.SecretID(req.SecretID))
	if errRes != nil {
		return nil, errRes
	}
	if sir == nil {
	...
	if sir == nil {
		sir, errRes = getSecretWithType(orgID, pkgSecret.StringsToSecretIDs(req.SecretIDs), string(providerID))
	}
	if errRes != nil {
		return nil, errRes
	}
...
func (req CreatePKEAWSClusterRequest) GetProviderID() providers.ProviderID {
	return providers.Amazon
}

func createEC2PKENetworkFromRequest(network pkgClusterPKE.Network, userID pkgAuth.UserID) internalPKE.Network {
...
func createEC2ClusterPKENodePoolsFromRequest(pools pkgClusterPKE.NodePools, userID pkgAuth.UserID) internalPKE.NodePools {
...
func createEC2ClusterPKEFromRequest(kubernetes pkgClusterPKE.Kubernetes, userID pkgAuth.UserID) internalPKE.Kubernetes {
...
func createEC2ClusterPKEKubeADMFromRequest(kubernetes pkgClusterPKE.KubeADM, userID pkgAuth.UserID) internalPKE.KubeADM {
...
func createEC2ClusterPKECRIFromRequest(cri pkgClusterPKE.CRI, userID pkgAuth.UserID) internalPKE.CRI {
	c := internalPKE.CRI{
...
func (req CreatePKEAWSClusterRequest) CreateCluster(ctx context.Context, organizationID pkgAuth.OrganizationID, userID pkgAuth.UserID) (cluster.Cluster, *pkgCommon.ErrorResponse) {
...
func (req CreateCustomClusterRequest) CreateCluster(ctx context.Context, organizationID pkgAuth.OrganizationID, userID pkgAuth.UserID) (cluster.Cluster, *pkgCommon.ErrorResponse) {
	return nil, nil // TODO
}
